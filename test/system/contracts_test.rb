...
class ContractsTest < ApplicationSystemTestCase
  ...
  test "creating a Contract" do
    ...
    fill_in "Car", with: @contract.car_id
    fill_in "Company", with: @contract.company_id
    fill_in "Rental user", with: @contract.rental_user_id
    fill_in "Trip", with: @contract.trip_id
